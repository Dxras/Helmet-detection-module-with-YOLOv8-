...
"}")
        ...
        self.logo.setStyleSheet(u"image: url(:/all/img/i.png);\n"
...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Title.setText(QCoreApplication.translate("MainWindow", u"Дорофеюк", None))
        self.ToggleBotton.setText(QCoreApplication.translate("MainWindow", u"Скрыть", None))
        self.src_file_button.setText(QCoreApplication.translate("MainWindow", u"Файл", None))
        self.src_cam_button.setText(QCoreApplication.translate("MainWindow", u"Камера", None))
        self.src_rtsp_button.setText(QCoreApplication.translate("MainWindow", u"Rtsp", None))
        self.VersionLabel.setText(QCoreApplication.translate("MainWindow", u"Demo", None))
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"Система контроля соблюдения техники безопасности  \u2013  Графический интерфейс для работы с системой распознования объектов", None))
        self.settings_button.setText("")
        self.min_sf.setText("")
        self.max_sf.setText("")
        self.close_button.setText("")
        self.char_label.setText(QCoreApplication.translate("MainWindow", u"Обнаружение объектов", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Классы", None))
        self.Class_num.setText("")
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Объекты", None))
        self.Target_num.setText("")
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Fps", None))
        self.fps_label.setText("")
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"Модель", None))
        ...
        self.ToggleBotton_6.setText(QCoreApplication.translate("MainWindow", u"Модель", None))
        ...
        self.ToggleBotton_4.setText(QCoreApplication.translate("MainWindow", u"Задержка(ms)", None))
        self.ToggleBotton_5.setText(QCoreApplication.translate("MainWindow", u"Сохранение", None))
        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"MP4/JPG", None))
        self.save_txt_button.setText(QCoreApplication.translate("MainWindow", u"Labels(.txt)", None))
        self.status_bar.setText(QCoreApplication.translate("MainWindow", u"Начните работу", None))
    # retranslateUi
